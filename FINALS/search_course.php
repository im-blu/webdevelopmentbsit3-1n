...
<body>
    ...
    <div class="s">
     ...
     <form action="" method="GET">
        <div>
            <div>
                <input type="text" name="course_id" value="<?php if(isset($_GET['course_id'])){echo $_GET['course_id'];} ?>" class="form-control c">
            </div>
            <div>
                        ...
                        <table class="table table-bordered">
                             <?php 
                                    ...
                                    if(isset($_GET['course_id']))
                                    {
                                        ...
                                        $query = "SELECT * FROM course WHERE course_title='$course_id' ";
